...
use ocl::core::{self, Error as OclCoreError, Result as OclCoreResult, OclPrm, Mem as MemCore, MemFlags, MemInfo, MemInfoResult, BufferRegion, MapFlags, AsMem, MemCmdRw, MemCmdAll, ClNullEventPtr, ClContextPtr, Error, CommandQueue, ClVersions};
use ocl::{Context, FutureMemMap, MemMap, Event, RwVec, FutureReadGuard, FutureWriteGuard, SpatialDims};
